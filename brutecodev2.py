...
#This code is not efficient as it has exponential time complexity
#this code is checks all possible combinations of the password then gives answer which is not efficient
...
if cracked_password:
    print(f"Password cracked successfully! Username: {username}, Password: {cracked_password}")
else:
